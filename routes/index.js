...
const supplementRoute = require("./apis/supplementRoute");
const vitaminRoute = require("./apis/vitaminRoute");
const settingsRoute = require("./apis/settingsRoute");
const advertiseRoute = require("./apis/advertiseRoute");
const ChatRoute = require("./apis/ChatRoute");
const MessageRoute = require("./apis/MessageRoute");
const permissionRoute = require("./apis/permissionRoute");
...
const mealsRoute = require("./apis/mealsRoute");
const bannersRoute = require("./apis/bannersRoute");
const prizesRoute = require("./apis/prizesRoute");
const winnersRoute = require("./apis/winnersRoute");
const customTrainingPlanRoute = require("./apis/customTrainingPlanRoute");
...
const mountRoute = (app) => {
  ...
  app.use("/api/v1/vitamins", vitaminRoute);
  app.use("/api/v1/settings", upload.none(), settingsRoute);
  ...
  app.use("/api/v1/prizes", prizesRoute);
  app.use("/api/v1/winners", winnersRoute);
  app.use("/api/v1/custom-training-plans", customTrainingPlanRoute);
